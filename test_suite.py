...
from tests.apply_ATS import apply
...
tc11 = unittest.TestLoader().loadTestsFromTestCase(EditActivity_ATS)
tc12 = unittest.TestLoader().loadTestsFromTestCase(apply)


TestSuite = unittest.TestSuite([tc1, tc2, tc3, tc4, tc5, tc6, tc7, tc8, tc9, tc10, tc11, tc11, ])

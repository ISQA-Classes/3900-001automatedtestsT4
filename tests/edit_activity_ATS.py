...
class Edit(unittest.TestCase):
    ...
    def test_add_activity(self):
        ...
        elem.send_keys("Our church is hosting a dinner for the homeless at St. Peter's Church. "
                      "Please stop by and lend a hand to the community to help your fellow human in Downtown, "
                      "Omaha on May 12, 2019.")
